...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.handleRowSync = function () {
        ...
        return merge_1.merge(this.changeNotification.changes, this.groupsService.changes
            .pipe(filter_1.filter(isLocked), switchMapTo_1.switchMapTo(this.ngZone.onStable.asObservable().pipe(take_1.take(1)))), this.editService.changed, this.resizeService.changes, this.columnResizingService.changes).pipe(tap_1.tap(function () { return _this.resetNavigationViewport(); }), filter_1.filter(isLocked))
            .subscribe(function () {
