import { Component, ElementRef, EventEmitter, Injectable, Input, NgModule, NgZone, Output, Renderer2, ViewChild } from '@angular/core';
    ...
    ResizeBatchService.prototype.schedule = function (instance, method) {
        ...
        if (!this.subscription) {
            this.ngZone.runOutsideAngular(function () {
                _this.subscription = fromPromise$1(_this.resolvedPromise)
...
export { ResizeSensorComponent, ResizeBatchService, ResizeSensorModule };
