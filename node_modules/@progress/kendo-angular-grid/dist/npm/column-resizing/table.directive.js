...
var TableDirective = /** @class */ (function () {
    ...
    TableDirective.prototype.ngOnInit = function () {
        ...
        var obs = this.service
            .changes.pipe(filter_1.filter(function (e) { return _this.locked === e.locked; }));
        this.subscription = obs.pipe(filter_1.filter(function (e) { return e.type === 'start'; }), tap_1.tap(this.initState.bind(this)), map_1.map(columnsToResize), switchMap_1.switchMap(function (take) {
            return obs.pipe(filter_1.filter(function (e) { return e.type === 'resizeTable'; }), map_1.map(function (e) { return e.delta; }), bufferCount_1.bufferCount(take));
