...
var ColorPickerComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ColorPickerComponent.prototype, "iconStyles", {
         ...
         */
        get: function () {
            if (utils_1.isPresent(this.iconClass)) {
                return this.iconClass;
            }
            if (utils_1.isPresent(this.icon)) {
    ...
    ColorPickerComponent.prototype.handleWrapperKeyDown = function (event) {
        if (event.keyCode === enums_1.Keys.down || event.keyCode === enums_1.Keys.enter) {
    ...
    ColorPickerComponent.prototype.handlePopupKeyDown = function (keyCode) {
        if (keyCode === enums_1.Keys.tab || keyCode === enums_1.Keys.escape) {
            this.toggleWithEvents(false);
            this.wrapper.nativeElement.focus();
        }
    };
    ...
    ColorPickerComponent.decorators = [
        { type: core_1.Component, args: [{
                    ...
                    providers: [{
                            ...
                            useExisting: core_1.forwardRef(function () { return ColorPickerComponent; }) // tslint:disable-line:no-forward-ref
                        }],
